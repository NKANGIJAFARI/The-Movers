...
//Get the posts related to the property by having same Usage
    const relatedPostByUsage = await db.collection('housePostings')
      ...
      relatedPosts.forEach(post =>{ 
          ...
          relatedPostsWrapper.innerHTML += postingCard((post.data().propertyDetails))
      });
    }
...
//           </span>
//         </p>
//         <p class="m-0 text-muted"><strong><span class="location">${data.location}</span></strong></p>

//         <a href="#landlordContacts" data-toggle="modal" data-target="#messageModal" data-uid="${data.uid}" class="landLordContactBtn">CONTACT LANDLORD</a>     
//         </div>

//         <div class="card__body--postedByDetails">
//           <img src="${data.postedByImg}" alt="Posted By" class="card__body--postedByImg Postedby">
